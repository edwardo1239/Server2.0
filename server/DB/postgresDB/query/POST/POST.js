const apiPOST = {
  ...
  ingresar_limpieza_mensual: async (data, client) => {
    console.log(data);
    const responsable = data.data.responsable;
    ...
    for(const item of data.data.data){
      ...
      const query = {
        text: "INSERT INTO limpieza_mensual (responsable, area, elemento, cumple, observaciones, fecha_ingreso) VALUES ($1, $2, $3, $4, $5, $6)",
        values: values // Aplanar el array de arrays
      };
      await client.query(query);
    }
